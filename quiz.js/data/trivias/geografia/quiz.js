...
if (template.length < 1) {
    ...
    template[4] = "string=\x0314Trivia ha sido iniciada por \x0310+n\x0314 - buena suerte!! :P";
    ...
    template[14] = "string=\x0314Bien hecho \x0310+n\x0314, has contenstado primero!! :)";
    template[15] = "string=\x0314Bien hecho \x0310+n\x0314, has contenstado segundo!! :)";
    template[16] = "string=\x0314Bien hecho \x0310+n\x0314, has contenstado correctamente!! :)";
    template[17] = "string=\x0314La trivia ha finalizado - aqui estan los resultados finales!!";
    template[18] = "string=\x0314(N) Nadie ha contestado ninguna de las preguntas correctamente (N)";
    template[19] = "string=\x0310+n \x0314recibió \x0301+p \x0314puntos";
    template[20] = "string=(H) (H) (H) \x0310+n \x0314ha ganado el juego con \x0301+p \x0314puntos!! (H) (H) (H)";
